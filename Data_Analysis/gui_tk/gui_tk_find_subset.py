...
class gui_tk_find_subset_class:
    ...
    def gui_tk_find_subset_frame(self, root, control_frame_config, text_area):
        ...
        tk.Button(frame_result.frame_6, text=control_frame_config['widget_text'][0],
        ...
        tk.Button(frame_result.frame_6, text=control_frame_config['widget_text'][1],
                  command=lambda: self.find_subset(frame_result.frame_1.entry_widget,
                                                   frame_result.frame_2.entry_value,
                                                   frame_result.frame_3.combobox_sheet,
                                                   frame_result.frame_4.combobox_item,
                                                   frame_result.frame_5.combobox_value,
                                                   text_area),
